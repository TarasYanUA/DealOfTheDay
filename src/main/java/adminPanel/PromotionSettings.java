...
public class PromotionSettings {
    ...
    private SelenideElement setting_AvailableFrom = $("input#elm_date_holder_from");
    private SelenideElement setting_AvailableTill = $("input#elm_date_holder_to");
    public void setDateForSetting_AvailableFrom(){
        String date = LocalDate.now().minusDays(1).format(DateTimeFormatter.ofPattern("MM-dd-yyy"));
    ...
    public void setDateForSetting_AvailableTill(){
        String date = LocalDate.now().plusDays(1).format(DateTimeFormatter.ofPattern("MM-dd-yyy"));
