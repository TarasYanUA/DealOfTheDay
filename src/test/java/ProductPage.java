...
public class ProductPage extends TestRunner {
    ...
    public void check_ProductPage() {
        ...
        basicPage.saveAndGoToStorefront(2);
        ...
        basicPage.saveAndGoToStorefront(3);
        ...
        basicPage.saveAndGoToStorefront(4);
        ...
        basicPage.saveAndGoToStorefront(5);
        ...
        basicPage.saveAndGoToStorefront(6);
